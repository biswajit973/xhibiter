"""
Django settings for xhibiter project.
...
SECRET_KEY = 'django-insecure-do&ud56en8j8i$1py)=iw_t=sfg_xc(6oj(cj&gi&sfs#l__t_'
...
WSGI_APPLICATION = 'xhibiter.wsgi.application'
